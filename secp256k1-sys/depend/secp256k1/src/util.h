...
typedef struct {
    ...
    const void* data;
} rustsecp256k1_v0_4_0_adaptor_0_callback;

static SECP256K1_INLINE void rustsecp256k1_v0_4_0_adaptor_0_callback_call(const rustsecp256k1_v0_4_0_adaptor_0_callback * const cb, const char * const text) {
...
static SECP256K1_INLINE void rustsecp256k1_v0_4_0_adaptor_0_memczero(void *s, size_t len, int flag) {
 ...
 */
static SECP256K1_INLINE int rustsecp256k1_v0_4_0_adaptor_0_memcmp_var(const void *s1, const void *s2, size_t n) {
...
static SECP256K1_INLINE void rustsecp256k1_v0_4_0_adaptor_0_int_cmov(int *r, const int *a, int flag) {
 ...
 * rustsecp256k1_v0_4_0_adaptor_0_ctz32_var, but permits it to be tested separately. */
static SECP256K1_INLINE int rustsecp256k1_v0_4_0_adaptor_0_ctz32_var_debruijn(uint32_t x) {
 ...
 * This function is only intended to be used as fallback for
 * rustsecp256k1_v0_4_0_adaptor_0_ctz64_var, but permits it to be tested separately. */
static SECP256K1_INLINE int rustsecp256k1_v0_4_0_adaptor_0_ctz64_var_debruijn(uint64_t x) {
...
/* Determine the number of trailing zero bits in a (non-zero) 32-bit x. */
static SECP256K1_INLINE int rustsecp256k1_v0_4_0_adaptor_0_ctz32_var(uint32_t x) {
    VERIFY_CHECK(x != 0);
    ...
    return rustsecp256k1_v0_4_0_adaptor_0_ctz32_var_debruijn(x);
#endif
}

/* Determine the number of trailing zero bits in a (non-zero) 64-bit x. */
static SECP256K1_INLINE int rustsecp256k1_v0_4_0_adaptor_0_ctz64_var(uint64_t x) {
    VERIFY_CHECK(x != 0);
#if (__has_builtin(__builtin_ctzl) || SECP256K1_GNUC_PREREQ(3,4))
...
#else
    /* If no suitable CTZ builtin is available, use a (variable time) software emulation. */
    return rustsecp256k1_v0_4_0_adaptor_0_ctz64_var_debruijn(x);
#endif
}
